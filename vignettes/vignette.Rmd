...
# Use Case
Through this app, users will have the opportunity to explore the effects of coronavirus (COVID-19) in the United States of America by various grouping variables and outcomes as of November 20, 2020. As we near the end of 2020 COVID-19 cases are on the rise again in the United States and understanding the effects by state can help you make informed decisions about your own wellbeing. (Mayo Clinic Staff, 2020). As we know there are many potential contributing factors to COVID-19 and this app will help you investigate some of those factors, such as pre-existing conditions, which we have seen affect COVID-19 progression (Ssentongo et al., 2020). This app is intended to answer questions about differences in COVID-19 occurrences and deaths by characteristics that might affect the user such as location (by state), gender, age, and pre-existing conditions. This app is not intended to predict or inform individuals specifically about themselves, this app is intended to inform users on overall rates by specific characteristics. This app will allow individuals to visualize and analyze COVID-19 cases and deaths across the United States. Users can investigate coronavirus through exploring COVID positive results, progression to extreme medical attention (individuals on ventilators), and death rates through several other factors (age, sex, location by state and pre-existing conditions). Additionally, users will be able to look at the general population statistics for the country and each state to better understand the impact COVID has had on the population. This app allows users to investigate COVID-19 in the United States with data collected between February 2020 and the end of November 2020. (Scott, 2020). This app is intended for individuals from the general population to use, with little background in statistical analysis and data visualization. This app is intended to be a user interface for individuals from any background, with an understanding of the English language, to investigate COVID-19 in the United States of America. Some background on statistical analysis (specifically analysis of variance) would be beneficial to the user but is not required due to the explanations and links to other resources provided within the app on how to interpret the analysis. This app will allow users to investigate COVID-19’s impact on the United States of America through three key ways: data exploration, data visualization, statistical analysis of group variations.
...
This shiny app was made using the shiny package, version 1.5.0. This package was used to design the app, as well as used in the creation of all statistical analyses, maps and graphs. This package is the backbone that allows this app to run. In addition, shinythemes package version 1.1.2 was used to help create the aesthetics of the app. The fresh package, version 0.2.0, was also used to help with the theme of the overall app. Another package that was used was the tidyverse package version 1.3.0. This package was used in the cleaning and preparing o f the data. Furthermore, the broom package version 0.7.0 was used.     In this app, the broom package was used to tidy the output from the statistical analyses to make it easier to read. Next, the sf package, version 0.9-6, and the tigris package, version 1.0, were both used to help create the geographical mapping of the United States. In creating the interactive map, the leaflet package, version 2.0.3, was used to aid in this process. Finally, the viridis package, version 0.5.1, was used to color the map made by the leaflet package.
